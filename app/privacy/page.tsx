...
export const metadata: Metadata = { title: "Privacy Policy", description: "Privacy information for the AtlasBlake Technologies LLC website and project inquiry process.", alternates: { canonical: "/privacy" } };

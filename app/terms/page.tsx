...
["Project information and written quotes","The public website describes AtlasBlake services and general project approach but does not create a binding quote. Final scope, deliverables, project fee, recurring rate if applicable, ownership, licensing, support, and timeline are established in the signed proposal, Service Agreement, and any approved addendum or change order."],

...
export const metadata: Metadata = { title: "Terms of Use", description: "General terms for using the public AtlasBlake Technologies website.", alternates: { canonical: "/terms" } };
export default function TermsPage(){return <main><Navbar/><PageHero eyebrow="Legal" title="Terms of Use" text="These terms apply to the public AtlasBlake Technologies website. Client projects, products, subscriptions, and support may be governed by separate written agreements."/><section className="bg-white px-6 py-20"><div className="mx-auto max-w-4xl"><p className="mb-10 text-sm font-bold text-[#71879d]">Last updated: July 25, 2026</p><div className="space-y-10">{[
...
["Project information and estimates","Website descriptions, examples, timelines, and budget ranges are general information. Final scope, deliverables, pricing, ownership, licensing, support, and timelines are established in the applicable written agreement."],
["Intellectual property","The AtlasBlake name, branding, website design, text, graphics, demonstrations, and product materials are owned by AtlasBlake Technologies or used with permission. Client ownership and licensing rights are defined by the project agreement."],
